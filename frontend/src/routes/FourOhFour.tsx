...
export default function FourOhFour() {
    return <div class="h-screen w-screen flex flex-col justify-center text-center">
        ...
        <span class="mx-auto mt-8">
            <Link to="/">
                <button class="transition duration-200  px-6 py-3 rounded-lg border-2 border-purple-600 text-purple-600 hover:bg-purple-600 hover:text-white text-2xl font-light">Home</button>
            </Link>
        </span>
    </div>
}